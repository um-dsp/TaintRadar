...
class DatabaseConstraint(val cpg: Cpg) {
    ...
    val reader = CSVReader.open("/home/umd-user/joern/projectcpg/code/db/schemas/" + file_name + "-database.csv")
    ...
    def debug() = {
        ...
        typeAndCode #> ("/home/umd-user/joern/projectcpg/code/db/parsed-queries/" + file_name + ".csv")
